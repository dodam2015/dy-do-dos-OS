...
# 복사할 폴더 경로
source_folder = os.path.join(current_folder, "install_program_file", "dy_do_dos_official_1.1")

# 바탕화면 경로 (Windows 환경)
desktop_folder = os.path.join(os.path.expanduser("~"), "Desktop")

# 복사될 경로
destination_folder = os.path.join(desktop_folder, "dy_do_dos_official_1.1")
...
# nickname.txt 파일 경로
nickname_file = os.path.join(desktop_folder, "dy_do_dos_official_1.1", "user", "nickname.txt")
...
print('이제 official_verison1_1.py파일을 더블클릭 하세요.')
time.sleep(10)
quit()