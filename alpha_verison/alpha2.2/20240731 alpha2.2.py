...
CMDhelp=["index(CMD/help) = help of cmd.", "index(shutdown/help) = see help for shutdown menu.", "disk left = print disk left (input) drive",
         "log-out = log out this user.", "system file fix = change system file", "index(system/variable) = enter variable and you enterd, print variable you entered."]
OSname='dy do OS'
OSverison='alpha2.2'
print('hello, user')
    ...
    if cmd=='index(CMD/help)':
        ...
        if diskXleft>=1000:
            ...
            if user_disk_full>=diskXfull-1000:
                ...
                disk_in_thisPC+=[user_disk]
        elif not diskXleft>=1000:
